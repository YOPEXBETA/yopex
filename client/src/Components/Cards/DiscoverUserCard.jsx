            ...
            <div className="flex-auto sm:ml-5 justify-evenly">
                ...
                <div className="flex items-center">
                  <div className="flex flex-col">
                    ...
                    <div className="flex-auto text-gray-400 my-1">
                      <span className="mr-3 ">
                        {option?.occupation?.name || "unknown"}
                      </span>
              ...
              <div className="flex flex-row items-center mt-1">
                {option?.reviews?.length > 0 ? (
                    (() => {
                      const totalStars = option.reviews.reduce((sum, review) => sum + review.star, 0);
                      const averageRating = (totalStars / option.reviews.length).toFixed(1);

                      return (
                          <div className="flex items-center">
                            <p className="text-lg font-bold dark:text-white me-1">{averageRating}</p>
                            <StarReviewIcon/>
                          </div>
                      );
                    })()
