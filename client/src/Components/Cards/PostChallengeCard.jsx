...
const PostChallengeCard = ({ extra }) => {
  return (
    <Card extra={`p-4 ${extra}`}>
      <div className="break-inside relative overflow-hidden flex flex-col justify-between space-y-3 text-sm rounded-xl p-4 mb-4">
        <div className="flex flex-row items-center space-x-3">
          ...
          <span className="text-lg font-bold">Your Team Hasn’t Posted Any Challenges, Yet!</span>
        </div>
        <div  className="text-base font-medium">Your teams posted Challenges will appear here. Start posting challenges and get matched with top talents.</div>
        <div className="flex justify-between items-center">
          ...
          <button className="flex items-center justify-center text-md font-medium rounded-full px-4 py-2 space-x-1 border-2 border-black bg-white hover:bg-black hover:text-white text-black dark:bg-slate-800 dark:text-white dark:border-white dark:hover:bg-white dark:hover:text-black">
...
export default PostChallengeCard;
