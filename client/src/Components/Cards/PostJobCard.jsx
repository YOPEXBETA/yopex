  ...
  return (
    <Card extra={`p-4 ${extra}`}>
      ...
      <div className="flex flex-row items-center space-x-3">
          ...
          <span className="text-lg font-bold">Your Team Hasn’t Posted Any jobs, Yet!</span>
        </div>
        <div  className="text-base font-medium">Your teams posted jobs will appear here. Start posting jobs and get matched with top talents.</div>
