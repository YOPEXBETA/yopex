...
const ProjectsProfile = ({
  ...
  return (
    ...
    >
        <button
          className="font-medium p-2 absolute top-0 right-2   rounded-full"
      ...
      <div className="flex w-full flex-col  bg-white border border-gray-200 rounded-lg  md:flex-row  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <div className="object-cover w-full  h-96 md:h-auto md:w-48 rounded-lg ">
