...
const ChallengeNavigationTab = ({ value, changeValue, isRegistered }) => {
  ...
  return (
    <div className="w-full">
      <div className="divide-gray-100 p-2 dark:border-zinc-500 overflow-hidden rounded-lg bg-slate-200 dark:bg-zinc-700  text-gray-600 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4">
        <button
