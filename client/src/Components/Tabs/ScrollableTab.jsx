  ...
  if (categories)
    return (
      <div className="w-full">
        <div className="p-4 divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-lg dark:bg-zinc-700 bg-white shadow-md  border-gray-300 text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4">
