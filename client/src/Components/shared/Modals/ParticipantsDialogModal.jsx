...
const ParticipantsDialogModal = ({ open, handleClose, participant, togglereview, isOwner }) => {
        ...
        <div className="relative bg-white rounded-lg shadow-lg dark:bg-gray-700">
            ...
            {submissions[0].filesPaths &&
                ...
                <button type="button" onClick={()=>{
                  handleClose();
                  togglereview();
                  }} className="text-white bg-green-400 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">review</button>
            </div>)}
