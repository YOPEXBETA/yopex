...
const StorePointCard = ({ points, amount, onClick }) => {
  return (
    <div className="w-full dark:bg-zinc-800 dark:text-white border z-10 rounded-lg p-6 shadow-md hover:shadow-2xl transform hover:scale-105 transition-transform duration-300 ease-in-out">
