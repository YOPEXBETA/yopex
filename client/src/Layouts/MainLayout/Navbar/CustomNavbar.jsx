...
const CustomNavbar = () => {
  ...
  return (
    <div>
      <div className="grid fixed w-full grid-cols-1 lg:grid-cols-12 dark:bg-zinc-800 bg-white items-center xl:px-16 px-6 border-b text-gray-600  lg:py-1 py-4 z-50">
