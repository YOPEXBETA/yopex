          ...
          <div className="flex flex-wrap items-center -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                <a
                  href="#"
                  className="inline-flex items-center justify-center py-3 text-base font-medium bg-orange-500 rounded-lg text-white border rounded-md border-primary bg-primary px-7 hover:border-blue-dark hover:bg-blue-dark"
                >
                  Know More
                </a>
              </div>
