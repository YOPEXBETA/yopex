...
const Contact = () => {
  return (
    <div name="contact" className="w-full  lg:px-24 md:px-11  border-b-2 dark:bg-zinc-800">
      <section className="relative  overflow-hidden bg-white dark:bg-zinc-800 py-20 lg:py-[120px]">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <h2 className="mb-6 text-[32px] dark:text-white font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="mb-9 dark:text-white text-base leading-relaxed text-body-color">
                  Have questions, suggestions, or need assistance? We're here to
                  help. Feel free to contact our dedicated team.
                </p>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 dark:text-white text-xl font-bold text-dark">
                      Our Location
                    </h4>
                    <p className="text-base dark:text-white text-body-color">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-white dark:bg-zinc-700 p-8 shadow-lg sm:p-12">
                <form
                ...
                >
                  <div className="mb-6">
                    <input
                      ...
                      className="border-[f0f0f0] w-full rounded border py-3 px-[14px] text-base text-body-color outline-none dark:text-white  dark:bg-zinc-800 focus:border-primary focus-visible:shadow-none"
                    />
                  </div>
                  <div className="mb-6">
                    <input
                      ...
                      className="border-[f0f0f0] w-full dark:text-white rounded border dark:bg-zinc-800 py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
                    />
                  </div>
                  <div className="mb-6">
                    <textarea
                      ...
                      className="border-[f0f0f0] w-full dark:text-white resize-none dark:bg-zinc-800 rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
                    ></textarea>
                  </div>
                  <div>
                    <button
