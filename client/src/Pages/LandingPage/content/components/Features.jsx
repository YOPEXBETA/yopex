...
const Features = () => {
  ...
  return (
    <div>
      <div
        name="about"
        className="w-full bg-white dark:bg-zinc-800 cursor-pointer lg:px-24 md:px-11 py-10 border-b-[1px]  border-gray-500"
      >
        <div className="pb-11">
          <p className="text-4xl font-extrabold text-center dark:text-white text-black">
            Features
          </p>
        </div>
          ...
          {features.map(({ id, icon, title, description }) => (
            ...
            >
              <div className="bg-white dark:bg-zinc-700 rounded-t-md p-4 h-72 flex flex-col items-center gap-5">
                ...
                <div>
                  <p className="text-xl dark:text-white text-black font-semibold text-center">
                    {title}
                  </p>
