...
const HighlightSection = () => {
  return (
    <div>
      <div className="mx-auto py-4 lg:px-24 md:px-11 bg-cover bg-black border-b-[1px] border-gray-500">
        <div className="text-center text-white flex flex-col items-center gap-16">
          <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 items-center lg:gap-48 gap-10 md:gap-32">
            ...
            <div className="p-4 flex flex-col items-center gap-2">
              <div>
                ...
                <p className="text-2xl font-medium">Recruiters</p>
              </div>
            </div>
            <div className="p-4 flex flex-col items-center gap-2">
              <div>
