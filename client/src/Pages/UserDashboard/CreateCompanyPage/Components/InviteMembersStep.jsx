        ...
        <div className="p-4">
            ...
            <div className="flex mb-4">
                ...
                <div className="flex-1 mr-2 mt-6">
                    {selectedUser === null ? (
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-700">Find members in Yopex :</label>
                            <input
                                type="text"
                ...
                <div className="flex-1 ml-2 mt-6">
                    <div className="mb-2">
                        <label className="block mb-2 text-sm font-medium text-gray-700">Send Invites using Email :</label>
                        <input
                            type="email"
