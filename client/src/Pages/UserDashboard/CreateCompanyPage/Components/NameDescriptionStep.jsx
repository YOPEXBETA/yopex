...
const NameDescriptionStep = ({ control, formData, organization, updateFormData }) => {
            ...
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                <div className="md:col-span-5">
                    ...
                    <Controller
                        ...
                        render={({field, fieldState}) => ( // Ensure fieldState is destructured here
                            <div>
                                <input
                                    {...field}
                                    onChange={(e) => {
                ...
                {organization === 'Company' && (
                    <div className="md:col-span-5">
                        <label className="text-sm text-black mb-2 block dark:text-white">Select the sector that best describes your {organization}
                        </label>
                        <Controller
