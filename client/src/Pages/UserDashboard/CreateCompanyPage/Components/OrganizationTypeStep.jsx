    ...
    return (
        <div>
            ...
            <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2">
                ...
                <OrganizationTypeCard onClick={() => handleCardClick('Non-Governmental Organization')}>
                    <div className="card-content">
                        <h3 className="text-xl font-bold text-center py-4">Non-Governmental Organization</h3>
                        <p className="text-gray-700 text-base px-6 pb-4">
