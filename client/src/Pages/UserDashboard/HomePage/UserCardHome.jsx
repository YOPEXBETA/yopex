...
const UserCardHome = () => {
  return (
    <div>
      <div className="w-full  rounded-lg border bg-white p-3  divide-y divide-gray-200">
        <div aria-label="header" className="flex gap-4 items-center p-4">
        ...
        <div aria-label="navigation" className="py-2">
          <nav className="grid gap-1">
            <a
              href="/"
              className="flex items-center leading-6 gap-3 py-3 px-4 w-full text-lg text-gray-600 focus:outline-none hover:bg-gray-100 rounded-md"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                aria-hidden="true"
        ...
        <div aria-label="footer" className="pt-2">
          <button
            type="button"
            className="flex items-center gap-3 py-3 px-4 w-full leading-6 text-lg text-gray-600 focus:outline-none hover:bg-gray-100 rounded-md"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
