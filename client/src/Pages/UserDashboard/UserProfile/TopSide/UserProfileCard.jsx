...
const UserProfileCard = () => {
  ...
  if (userProfile)
    return (
      <div className="bg-white dark:bg-zinc-800 p-6 md:rounded-lg flex flex-col items-center gap-6 xl:mr-11 dark:shadow-green-500 md:shadow-md md:border-green-500 border-b-2 mr-0">
